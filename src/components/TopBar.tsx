    ...
    <>
      <header className={`flex h-[112px] flex-col gap-2 border-b px-4 py-3 ${showProdWarning ? 'border-rose-700/80' : 'border-slate-800'}`}>
        <div className="flex items-center gap-2">
          ...
          <button
            className="rounded border border-slate-600 bg-slate-800 px-4 py-2 text-slate-100 hover:bg-slate-700"
      ...
      <MobilePairingDialog open={isMobilePairingOpen} onClose={() => setIsMobilePairingOpen(false)} />
    </>
  );
};
